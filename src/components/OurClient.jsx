      ...
      <div className="bg-[#fffcf6]">
        <div className="max-w-[1440px] mx-auto">
          <div className="max-w-[1164px] mx-auto px-4 md:px-3 py-6 sm:py-10 md:py-12 lg:py-[55px]">
            <h2 className="font-inter text-[30px] sm:text-[32px] md:text-[36px] lg:text-[40px] xl:text-5xl font-bold flex items-center justify-center text-center !leading-[121%] mb-3 md:mb-4">
              What Our Client Say
            </h2>
            <p className="font-inter text-[14px] sm:text-base font-normal mx-auto max-w-[570px] text-center text-primaryblack leading-[150%] mb-6 md:mb-8 lg:mb-10">
            ...
            <div className="flex items-center lg:flex-row flex-col justify-end gap-3 sm:gap-5 md:gap-7 xl:pt-5">
              ...
              <div className="w-full !max-w-[558px]">
                  ...
                  {ClientContent.map((obj, index) => (
                    <SwiperSlide key={index} className="swiper-slide">
                      <div className="flex flex-col">
                        <img
                          className="w-[48px] sm:w-[60px] md:w-[70px] lg:w-[82px] mb-3 sm:mb-4 md:mb-5"
                          src={obj.InvertedComa}
                          alt="InvertComa"
                        />
                        <p className="font-inter font-normal text-[14px] sm:text-base leading-[150%] text-black opacity-70 max-w-[558px]">
                          {obj.Paragraph}
                        </p>
                        <p className="font-inter font-medium text-base !leading-[121%] mt-4 text-black">
                          {obj.Name}
                        </p>
                        <p className="font-inter font-medium text-base !leading-[121%] text-black opacity-70 mt-1 sm:mt-2">
                          {obj.Text}
                        </p>
                      </div>
                    </SwiperSlide>
                ...
                <div className="mt-3 sm:mt-4 md:mt-5 lg:mt-6 xl:mt-8 gap-3 flex">
                  <button className="z-[10]" onClick={prevarrow}>
                    <SliderPrevbtn />
                  </button>
                  <button className=" z-[10]" onClick={nextarrow}>
                    <SliderNextbtn />
                  </button>
                </div>
              </div>
