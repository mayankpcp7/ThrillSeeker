            ...
            <div className='bg-[#fffcf6]'>
                <div className='max-w-[1440px] mx-auto'>
                    <div className='max-w-[1164px] mx-auto px-4 md:px-3 py-6 sm:py-10 md:py-12 lg:py-[55px]'>
                        ...
                        <p className='font-inter text-[14px] sm:text-base font-normal mx-auto max-w-[570px] text-center text-secondaryblack leading-[150%] mb-4 sm:mb-6 md:mb-8 lg:mb-10'>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
