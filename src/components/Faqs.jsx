    ...
    return (
        <div className='max-w-[1440px] mx-auto relative mt-12 md:mt-[60px] lg:mt-20 xl:mt-[100px]' id='faq'>
            <div className='max-w-[1164px] px-5 md:px-3 mx-auto relative'>
                <h2 className='font-inter text-[30px] sm:text-[32px] md:text-[36px] lg:text-[40px] xl:text-5xl font-bold flex items-center justify-center text-center leading-[121%] mb-2 lg:mb-4'>Frequently Asked Questions</h2>
                <p className='font-inter text-[14px] sm:text-base font-normal mx-auto max-w-[557px] text-center text-primaryblack leading-[150%] mb-4 sm:mb-6 lg:mb-10'>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
                <div className='flex items-center justify-center flex-wrap z-10 relative'>
                    ...
                    <div className='pb-12 md:pb-[60px] lg:pb-20 xl:pb-[100px]' data-aos="zoom-in" data-aos-duration="500" data-aos-delay="300" data-aos-easing="linear" >
                        ...
                        {FaqContent.map((faqitem, index) => (
                            <div key={index} className="pb-4 sm:pb-6 !w-full lg:w-[922px]">
                                <div className={`border border-solid border-[#cbcaca] rounded-[14px] md:rounded-[20px] px-4 md:px-[26px] faqbox bg-[#fefdfd] shadow-FaqShadow ${expandedIndex === index ? 'active' : ''}`}>
                                    <button
                                        type="button"
                                        className={`flex items-center justify-between w-full text-left text-base md:text-xl !leading-[121%] pt-[26px] ${expandedIndex === index ? 'pb-[0px]' : 'pb-[26px]'} !font-medium text-dark font-inter ${expandedIndex === index ? 'text-color' : ''}`}
                    ...
                    <div className='w-full shadow-common overflow-hidden bg-map bg-no-repeat bg-cover bg-center rounded-[15px] md:rounded-[28.5px] py-8 md:py-10 lg:py-14 xl:py-[63px] bg-white relative -mt-[100px] translate-y-[30%]'>
                        ...
                        <div className='relative z-10 px-3'>
                            ...
                            <p className='font-inter text-[14px] sm:text-base font-normal mx-auto max-w-[557px] text-center text-[#494949] !leading-[160%] mt-1 sm:mt-2 lg:mt-4'>Lorem Ipsum is simply dummy text of the printing and typesetting</p>
                            {/*========================================= Email Validation =========================================*/}
