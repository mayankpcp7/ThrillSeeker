...
//========================================== Destinatgion Cards ==========================//
export const DestinatgionCards = [
  {
    id: 1,
    DestinationImages: MaldivesIsland,
    Heading: "Maldives-Island",
    Paragraph: "It is a long established fact that a reader will distracted by",
    HideParagraph:
      "the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using.",
    BtnText: "Read More",
  },
  {
    id: 2,
    DestinationImages: KarbiIsland,
    Heading: "Long-Boat-Blue-Water",
    Paragraph: "It is a long established fact that a reader will distracted by",
    HideParagraph:
      "the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using.",
    BtnText: "Read More",
  ...
  {
    id: 3,
    DestinationImages: CliffMountainThailand,
    Heading: "Long-Tail-Boat-Turquoise",
    Paragraph: "It is a long established fact that a reader will distracted by",
    HideParagraph:
      "the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using.",
    BtnText: "Read More",
