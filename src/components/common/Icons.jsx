...
export const TwitterIcon = () => {
    return (
        <svg className="footer_link_hov" width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="0.5" y="0.91748" width="29" height="29" rx="14.5" stroke="#FFBE4A" />
            <path d="M12.6705 7.39551H7.5L13.6011 15.6568L7.83239 22.3955H9.78977L14.5082 16.8838L18.5795 22.3955H23.75L17.3918 13.787L22.8636 7.39551H20.9062L16.4848 12.56L12.6705 7.39551ZM19.3182 20.8955L10.4545 8.89551H11.9318L20.7955 20.8955H19.3182Z" fill="#FFBE4A" />
        </svg>
    );
};
// Twitter icon component
export const FacebookIcon = () => {
    return (
        <svg className="footer_link_hov" width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="0.5" y="0.91748" width="29" height="29" rx="14.5" stroke="#FFBE4A" />
            <path d="M16 16.925H18.1429L19 13.125H16V11.225C16 10.2465 16 9.325 17.7143 9.325H19V6.133C18.7206 6.09215 17.6654 6 16.5511 6C14.224 6 12.5714 7.57415 12.5714 10.465V13.125H10V16.925H12.5714V25H16V16.925Z" fill="#FFBE4A" />
        </svg>
    );
};
...
export const SliderPrevbtn = () => {
    return (
        <svg className="slider_arrow_hov" width="35" height="36" viewBox="0 0 35 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle opacity="0.7" cx="17.5" cy="18" r="17" stroke="#FA6458" />
            <path opacity="0.7" d="M16.328 18L21.278 13.05L19.864 11.636L13.5 18L19.864 24.364L21.278 22.949L16.328 17.999L16.328 18Z" fill="#FA6458" />
        </svg>
    );
};
// Slider next btn
export const SliderNextbtn = () => {
    return (
        <svg className="slider_arrow_hov" width="35" height="36" viewBox="0 0 35 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle opacity="0.7" cx="17.5" cy="18" r="17" stroke="#FA6458" />
            <path opacity="0.7" d="M18.9501 18.364L14.0001 23.314L15.4141 24.728L21.7781 18.364L15.4141 12L14.0001 13.415L18.9501 18.365V18.364Z" fill="#FA6458" />
        </svg>
