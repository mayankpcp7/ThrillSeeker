    ...
    return (
        <div className='bg-BlogImg bg-cover bg-center bg-no-repeat'>
            <div className='max-w-[1440px] mx-auto'>
                <div className='max-w-[1164px] mx-auto px-4 md:px-3 mb-[436px]'>
                    <div className='pt-[97px] pb-[216px]'>
                        <h2 className='text-white font-inter font-bold text-5xl !leading-[121%]'>Our Blogs</h2>
                        <p className='font-inter opacity-70 text-white max-w-[504px] text-base leading-[150%] font-normal mt-4'>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                    </div>

                    <div className='gap-6 flex items-center justify-center flex-wrap -mt-[536px] translate-y-[78.5%]'>
