                    ...
                    <SwiperSlide className="p-4" key={ticket.id}>
                      <div className="flex overflow-hidden ticketcard shadow-TouristImageShadow max-w-[526px] flex-col ticketcard p-3 sm:p-6 rounded-[20px] items-center">
                        <div className="overflow-hidden rounded-[20px]">
                          <img className="max-w-[478px] transition-all duration-300 w-full ticketimg" src={ticket.img} alt="girlimg" />
                        </div>
                        <h5 className="text-black font-inter text-xl sm:text-2xl mt-5 font-medium capitalize">{ticket.class}</h5>
                        <p className="text-center font-inter text-sm sm:text-base text-primaryblack max-w-[476px]">{ticket.about}</p>
                        <h6 className="text-black text-lg sm:text-xl font-inter mt-4 font-medium">{ticket.price}</h6>
                        <a className="mt-4 sm:mt-6 text-base hover:text-black transition-all duration-300 font-semibold underline font-inter text-extralightred" href="#BookNow">{ticket.book}</a>
                      </div>
                    </SwiperSlide>
                  ))}
                </Swiper>
