          ...
          <div className="flex justify-between w-full items-center">
            ...
            <div className={`flex flex-col md:flex-row  fixed md:relative w-full z-50 min-h-screen md:min-h-0 top-[0] left-[-100%] md:left-0 ttransition-opacity duration-700 md:transition-none  justify-center md:justify-end items-center ${head ? "" : "!left-0 bg-white"}`}>
              ...
              <ul className="flex md:hidden gap-8 flex-col md:flex-row items-center">
                <li className="transition-all duration-300 relative"><a onClick={showUl} className="font-inter text-[20px] sm:text-[24px] md:text-base transition-all duration-300 before:w-0 before:transition-all before:duration-300 before:ease-linear  before:content-[''] before:h-[3px] w-0  hover:before:w-full before:absolute before:left-0 before:bottom-[-3%] before:bg-lightred  stroke_2" href="#home">Home</a></li>
                <li className="transition-all duration-300 relative"><a onClick={showUl} className="font-inter text-[20px] sm:text-[24px] md:text-base transition-all duration-300 before:w-0 before:transition-all before:duration-300 before:ease-linear  before:content-[''] before:h-[3px] w-0  hover:before:w-full before:absolute before:left-0 before:bottom-[-3%] before:bg-lightred hover:text-black hover_stroke2 text-secondaryblack opacity-70 hover:opacity-100" href="#aboutus">About Us</a></li>
              ...
              <ul className="hidden md:flex items-center gap-5 lg:gap-8">
                <li className="transition-all duration-300 relative"><a className="font-inter text-[20px] sm:text-[24px] md:text-base transition-all duration-300 before:w-0 before:transition-all before:duration-300 before:ease-linear before:content-[''] before:h-[3px] w-0  hover:before:w-full before:absolute before:left-0 before:bottom-[-3%] before:bg-lightred  stroke_2" href="#home">Home</a></li>
                <li className="transition-all duration-300 relative"><a className="font-inter text-[20px] sm:text-[24px] md:text-base transition-all duration-300 before:w-0 before:transition-all before:duration-300 before:ease-linear before:content-[''] before:h-[3px] w-0  hover:before:w-full before:absolute before:left-0 before:bottom-[-3%] before:bg-lightred hover: hover_stroke2 text-secondaryblack opacity-70 hover:opacity-100" href="#aboutus">About Us</a></li>
                <li className="transition-all duration-300 relative"><a className="font-inter text-[20px] sm:text-[24px] md:text-base transition-all duration-300 before:w-0 before:transition-all before:duration-300 before:ease-linear before:content-[''] before:h-[3px] w-0  hover:before:w-full before:absolute before:left-0 before:bottom-[-3%] before:bg-lightred hover: hover_stroke2 text-secondaryblack opacity-70 hover:opacity-100" href="#discover">Discover</a></li>
                <li className="transition-all duration-300 relative"><a className="font-inter text-[20px] sm:text-[24px] md:text-base transition-all duration-300 before:w-0 before:transition-all before:duration-300 before:ease-linear before:content-[''] before:h-[3px] w-0  hover:before:w-full before:absolute before:left-0 before:bottom-[-3%] before:bg-lightred hover: hover_stroke2 text-secondaryblack opacity-70 hover:opacity-100" href="#faq">FAQ’s</a></li>
